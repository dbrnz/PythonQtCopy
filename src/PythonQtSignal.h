...
extern PYTHONQT_EXPORT PyTypeObject global_PythonQtSignalFunction_Type;

#define PythonQtSignalFunction_Check(op) ((op)->ob_type == PythonQt::self()->PythonQtSignalFunctionType())
