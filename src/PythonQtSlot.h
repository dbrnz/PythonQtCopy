...
extern PYTHONQT_EXPORT PyTypeObject global_PythonQtSlotFunction_Type;

#define PythonQtSlotFunction_Check(op) ((op)->ob_type == PythonQt::self()->PythonQtSlotFunctionType())
